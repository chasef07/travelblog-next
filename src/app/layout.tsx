  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body suppressHydrationWarning className="min-h-screen flex flex-col">
        ...
        <Script id="theme-script" strategy="beforeInteractive">{`(function(){try{var t=localStorage.getItem('theme');var m=window.matchMedia&&window.matchMedia('(prefers-color-scheme: dark)').matches;document.documentElement.setAttribute('data-theme',t|| (m?'dark':'light'));}catch(e){}})();`}</Script>
