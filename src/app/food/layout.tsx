...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Discover authentic local cuisines from 20 countries. Street food guides, restaurant recommendations, and cultural eating experiences from Asia, Africa, and Central America.',
  path: '/food',
