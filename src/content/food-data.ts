  ...
  Vietnam: [
    {
      name: 'Pho Bo',
      description:
        'A fragrant and comforting Vietnamese noodle soup made with tender slices of beef, flat rice noodles, and a rich, slow-simmered broth infused with star anise, cloves, cinnamon, ginger, and fish sauce, topped with fresh herbs, lime, and chili.',
  ...
  China: [
    {
      name: 'Mapo Tofu',
      description:
        'A spicy and flavorful Sichuan dish featuring soft tofu, ground meat, and a bold, numbing sauce made with doubanjiang (fermented chili bean paste), Sichuan peppercorns, and garlic.',
    ...
    },
    {
      ...
      description:
        'Classic Sichuan dish made with stir-fried chicken, crunchy peanuts, dried chili peppers, and a savory-sweet sauce. Infused with the tongue-tingling heat of Sichuan peppercorns.',
  ...
  Laos: [
    {
      name: 'Laap',
      description:
        'A traditional minced meat or fish salad. Served with sticky rice and spicy sauces. Laap means "good fortune" or "luck" in Lao, so it\'s often served at weddings, New Year\'s celebrations, and family gatherings. It\'s a symbol of Lao identity and is one of the most famous dishes from Laos worldwide.',
  ...
  Thailand: [
    {
      ...
      description:
        "A vibrant Thai-inspired dish combining fragrant jasmine rice with sweet pineapple chunks, vegetables, and savory seasonings like soy sauce and curry powder. Often garnished with cashews and fresh cilantro, it's a delightful blend of sweet, savory, and nutty flavors.",
    ...
    },
    {
      ...
      description:
        'A creamy and aromatic Northern Thai coconut curry noodle soup, featuring soft egg noodles in a rich, spiced broth, topped with crispy fried noodles for texture. Often served with lime, pickled mustard greens, and chili oil, it offers a perfect balance of creamy, tangy, and spicy flavors.',
    ...
    },
    {
      ...
      description:
        'Sweet mangoes with creamy coconut-infused sticky rice. This delightful combination of textures and flavors is a tropical treat, often garnished with sesame seeds or mung beans for a perfect balance of sweetness and nuttiness.',
  ...
  Georgia: [
    {
      name: 'Churchkhela',
      description:
        'Almonds, walnuts, or hazelnuts are threaded onto a string and dipped in thickened grape must or fruit juices and dried in the shape of a sausage.',
    ...
    },
    {
      name: 'Khinkali',
      description:
        'A dumpling made of twisted knobs of dough stuffed with meat.',
    ...
    },
    {
      name: 'Khachapuri',
      description:
        'A bread dish filled with cheese. Adjaruli khachapuri, pictured here, contains an egg. Imeruli and Megruli are other varieties of Khachapuri with extra cheeses.',
