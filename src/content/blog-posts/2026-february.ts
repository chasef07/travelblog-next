...
export const february2026Posts: BlogPost[] = [
  {
    ...
    year: '2026',
    excerpt:
      'Landing back in Florida feeling more out of place at home than anywhere else in the world, and why that is exactly the point.',
...
The past month in Santa Teresa has taught me valuable lessons. Kyle and I came to Costa Rica this time as the Data Buddies, now we are leaving as more confident, more directed, more focused leaders and business men. When we started this business it was just about trying to get something to work, be able to have people pay us for an idea. Now that we have proven this is possible, it is about growing this life and defending it with all your power. In entrepreneurship you cannot be complacent because it can all be taken away from you in the snap of a finger. You need to have a plan to sustain and grow the business to support the amazing life we are building for ourselves. It is vital to be curious to keep on searching for new ideas, to have humility, to be able to change your mind and your opinions for better ones. To have self pride and respect so people do not walk all over you.`,
  ...
  },
  {
    ...
    year: '2026',
    excerpt:
      'Wrapping up 1.5 months in Santa Teresa with reflections on surfing, discovering yerba mate, entrepreneurship, and heading back to Florida after 3 months abroad.',
...
As for what's next? I will be back in Florida for a little before planning out my next attack.`,
  ...
  },
  {
    ...
    year: '2026',
    excerpt:
      'Writing from WhatsApp with ClaudeBot transcribing, reflecting on presence, communication, and the tech letting me stay close to the waves and the work.',
...
We are building healthcare agents during the day, paddling out at dawn, eating casado with the crew at night. These routines remind me that presence is a muscle. Tech should serve it, not siphon it. For now, I am just grateful the tools are letting me stay close to the waves while still showing up for the people counting on us.`,
  ...
  },
  {
    ...
    year: '2026',
    excerpt:
      'A month into Santa Teresa: surfing at sunrise, building with Kyle, and shifting from travel mode to mission mode.',
