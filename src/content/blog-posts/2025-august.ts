...
export const august2025Posts: BlogPost[] = [
  {
    ...
    year: '2025',
    excerpt:
      'Reflecting on eleven months since my world tour began - transitioning from collecting life data to implementing insights into action.',
...
My world tour was about collecting data—discovering how I want to live, where, with whom, and why. Now begins the real journey: implementing those insights into action, transforming theory into practice. That will be a challenge, but it's one I'm ready for. I believe I'm on the right track, and I'll keep trekking along the way.`,
  ...
  },
  {
    ...
    year: '2025',
    excerpt:
      'Reflecting on maintaining travel lessons after two weeks back home - health, boundaries, and the challenge of slow living in a fast environment.',
...
The best part of my trip was feeling unique, adventurous, and alive. That is the energy I want to protect and carry forward.`,
  ...
  },
  {
    ...
    year: '2025',
    excerpt:
      'First week back in Florida after 10 months of worldwide travel - appreciating local wildlife while confronting broken food systems and lifestyle differences.',
