...
export const november2024Posts: BlogPost[] = [
  {
    ...
    images: [
      {
        src: '/assets/images/misc/colors.jpg',
        alt: 'Colors and symbols in Nepal',
      },
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'One day in Dubai as an intermission between Africa and Asia, visiting Burj Khalifa and experiencing indoor skiing.',
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'First time back in a developed nation, observations on consumption culture and reuniting with Zach.',
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      "Final day in Africa, visiting the Genocide Memorial and learning about Rwanda's tragic history.",
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'Meeting world-renowned artist Innocent at Inema Art Center and creating art together.',
    ...
    images: [
      ...
      {
        src: '/assets/images/misc/consciousness.jpg',
        alt: 'Art creation with Innocent',
      },
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      "Exploring gravity economics theory and luxury market opportunities in Rwanda's growing middle class.",
    ...
    images: [
      ...
      {
        src: '/assets/images/misc/coffee.jpg',
        alt: 'Coffee culture in Rwanda',
      },
    ],
  },
  {
    ...
    year: '2024',
    excerpt:
      'Hardcore adventure capitalism day exploring Kigali and meeting with restaurant owner Matt.',
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      "Zach's detention at Kenyan train station and my arrival in the incredibly clean and safe city of Kigali.",
    ...
    images: [
      {
        src: '/assets/images/misc/kigaliport.jpg',
        alt: 'Arriving in Kigali airport',
      },
    ],
  },
  {
    ...
    year: '2024',
    excerpt:
      'Deep thoughts during the 6-hour train ride about travel philosophy, religion, and African corruption.',
...
Near the end of my six hour train ride to Nairobi I talked with a Kenyan woman. She said the biggest problem with Kenya is corruption. Also, Kenya is teeming with natural resources, but due to government incompetence there are no factories to refine or manufacture them. This leads to Kenya needing to export the natural resources out to then import the finished products back in. Throughout this process developed countries take advantage of the poorer nation of Kenya and the incompetent government. Kenya also needs to take loans from wealthy nations and then becomes debt trapped, specifically from China. Lastly, the corruption goes so far that even if you go to university it's hard to find a job. You need to pay someone in the know to get a good job. The woman thought that an African union would be beneficial but neighboring countries in East Africa hate each other. Corruption eats everything.`,
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'Learning the "pole-pole" philosophy of slowing down and preparing for the next leg to Rwanda and Nepal.',
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'Two months into travel, reflecting on the importance of community building and future possibilities.',
    ...
    images: [
      ...
      {
        src: '/assets/images/misc/diani2.jpg',
        alt: 'Beach reflections in Diani',
      },
    ],
  },
  {
    ...
    year: '2024',
    excerpt:
      "Ron's last day with us and reflections on building wealth, patience, and the value of time.",
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'One of the best days of the trip with beach yoga, kite surfing lessons, and volleyball.',
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'Honest assessment of the challenges of backpacking Africa and comparing Kenya vs Tanzania.',
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'Returning from an incredible 6-day safari and hunting with the Hadza tribe - a life-changing experience.',
    ...
    images: [
      {
        src: '/assets/images/misc/leopard.jpg',
        alt: 'Leopard spotted on safari',
      },
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'Witnessing motorcycle theft, crossing into Tanzania, and preparing for the epic Serengeti safari.',
    ...
    images: [
      ...
      {
        src: '/assets/images/misc/soccergame.jpg',
        alt: 'Soccer match in Tanzania',
      },
  ...
  },
  {
    ...
    year: '2024',
    excerpt:
      'First impressions of Africa, trying ostrich meatballs, and preparing for the Tanzania safari.',
    content: `I haven't given my first impressions on Africa, let me do that. They drive on the left side of the road which is interesting. Everything is pretty cheap except the touristy experiences. Nairobi is not the cleanest city. It is hot and dirty. The people seem nice but there is definitely some looks you get as a muzungu, white person. Everyone speaks really good English here, way better than Israel and Georgia. The people also speak Swahili which is cool. You do see poverty and people begging in the streets. A lot of people are selling random shit like white boards, flashlights, hats, just to make some money. I really like it so far all things considered though! Nairobi is one of the most developed cities, but it is still less developed than I expected. Today I tried ostrich meatballs which was pretty yummy and interesting at The Carnivore Restaurant. I had a traditional East African dish called Ugali, now saved on the Kenya country page. Tomorrow I wake up early and head to Tanzania for a 5 day Serengeti safari. Hopefully crossing the border goes smoothly. Ron will meet up with us in Tanzania tomorrow for a week and a half! That'll be fun. Still processing all that information from yesterday wow!`,
    images: [
      {
        src: '/assets/images/misc/ostritch.jpg',
        alt: 'Ostrich meatballs at The Carnivore',
      },
    ],
  },
  {
    ...
    year: '2024',
    excerpt:
      'Eye-opening conversation with Erik about African geopolitics, economics, and switching to backpacker mindset.',
    ...
    images: [
      {
        src: '/assets/images/misc/erik.JPG',
        alt: 'Meeting with Erik in Nairobi',
      },
    ],
  },
]
