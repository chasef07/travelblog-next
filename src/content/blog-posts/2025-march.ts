...
It was definitely a super unique experience.`,
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'Exploring Huanglong and Jiuzhaigou National Parks near the Tibetan Plateau - surreal colored pools and stunning mountain scenery.',
...
Seeing China's unique landscapes and getting a glimpse of Tibetan culture outside of the big cities was an unforgettable experience.`,
    images: [
      { src: '/assets/images/misc/huanglong.jpg', alt: 'Huanglong National Park colored pools' },
      { src: '/assets/images/misc/juzzy1.jpg', alt: 'Jiuzhaigou National Park lake' },
      { src: '/assets/images/misc/juzzy2.jpg', alt: 'Jiuzhaigou National Park waterfall' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Discovering China\'s unique life spa culture, learning about Chinese ethnic minorities, and navigating the essential apps needed for modern China.',
...
Also, in People's Park, you see people playing badminton, dancing, and playing games. I think activities like this help strengthen national identity too.`,
    images: [
      { src: '/assets/images/misc/volcanoroom.jpg', alt: 'Volcano room at the life spa' },
      { src: '/assets/images/misc/pptea.jpg', alt: 'Tea time at People\'s Park' },
      { src: '/assets/images/misc/teaholder.jpg', alt: 'Traditional tea holder' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Visiting Sichuan pandas, getting a haircut in China, experiencing traditional Sichuan Opera with incredible acrobatics and face-changing shows.',
...
I also had Kung Pao chicken, which Chengdu is known for. The spice killed me, but it was good. I was so tired from running around the past few days that I just crashed after that.`,
    images: [
      { src: '/assets/images/misc/pandas.jpg', alt: 'Sichuan pandas at Panda Valley' },
      { src: '/assets/images/misc/teatea.jpg', alt: 'Tea ceremony at Mi Xun teahouse' },
      { src: '/assets/images/misc/opera.jpg', alt: 'Traditional Sichuan Opera performance' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Hiking the sacred Daoist mountain Qingchengshan and exploring the ancient water management system of Dujiangyan.',
...
I found an awesome and cheap place on Trip.com. The owner, whose English name was Spencer, was a sweetheart. He spoke some English and told me he liked the USA. Even though I was exhausted, I gathered enough energy to walk to a famous bridge and riverside. I wanted to fly my drone for the first time, but I decided against it—it was dark, windy, and over water. Flying a drone is actually not that straightforward, and it would've sucked to lose it on my first try. Instead, I drank tea at the hotel and went to bed. A much-needed private room rest.`,
    images: [
      { src: '/assets/images/misc/qingshen.jpg', alt: 'Qingcheng Mountain temple' },
      { src: '/assets/images/misc/chinaflag.jpg', alt: 'Chinese flag on the mountain' },
      { src: '/assets/images/misc/dujiangynan.jpg', alt: 'Ancient Dujiangyan irrigation system' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Six months into my world tour - experiencing traditional Chinese bathhouse culture and navigating the essential apps for life in China.',
...
To end the day, I went back to People's Park at night for some tea.`,
    images: [
      { src: '/assets/images/misc/peopleparky.jpg', alt: 'Evening at People\'s Park' },
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'Epic 48-hour journey from Angkor Wat sunrise to arrival in China - experiencing the transit visa process and first impressions of Chengdu.',
...
This was one of the craziest 48 hours of my life, but I was so stoked to finally be in China.`,
    images: [
      { src: '/assets/images/misc/angorwox.jpg', alt: 'Sunrise at Angkor Wat on spring equinox' },
      { src: '/assets/images/misc/airportvibes.jpg', alt: 'Waiting at the airport' },
      { src: '/assets/images/misc/chinastreet.jpg', alt: 'First impressions of Chinese streets' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Deep reflections on the journey so far - sharing insights on health, standing up for values, and the evolution of travel perspectives.',
  ...
  },
  {
    ...
    year: '2025',
    excerpt: '10 temples, 1 man - First day exploring the celestial city of Angkor with ChatGPT as my guide and a semi-automatic motorbike as transport.',
    ...
    images: [
      ...
      { src: '/assets/images/misc/buddhatemp.jpg', alt: 'Buddha temple with carved faces' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Learning about Cambodia\'s complex religious blend and tragic recent history through a 16km cycling tour of the countryside.',
    ...
    images: [
      ...
      { src: '/assets/images/misc/camcountry.jpg', alt: 'Cambodian countryside' },
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'Visiting the Apopo Center where African giant pouched rats are trained to detect landmines and unexploded bombs from Cambodia\'s tragic past.',
    ...
    images: [
      { src: '/assets/images/misc/herorat.jpg', alt: 'Hero rat detecting explosives' },
      { src: '/assets/images/misc/mrlick.jpg', alt: 'Getting licked by a hero rat' },
      { src: '/assets/images/misc/mrratty.jpg', alt: 'Holding a trained detection rat' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Celebrating Shabbat with older expats in Phnom Penh and arriving in Siem Reap - learning from experienced travelers about opportunities and perspective.',
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'Reflecting on SE Asian toilet paper culture, celebrating Purim at Chabad, and feeling grateful looking back at 6 months of travel photos.',
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'Finishing The Three Musketeers and reflecting on lessons about friendship, respect in conflict, and directness in relationships from 17th century France.',
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'Exploring world-famous Kampot pepper plantation, getting my first travel fine from police, and ranking my favorite sauna experiences.',
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'Living the healthy life in Kampot for $10/day - gym, sauna, cold plunge, and fresh coconuts while learning about price discrimination economics.',
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'Leaving the paradise of Koh Rong after 2 weeks and discovering the charming riverside town of Kampot with its French colonial architecture and modern infrastructure.',
    ...
    images: [
      { src: '/assets/images/misc/backpackselfie.jpg', alt: 'Backpack selfie leaving Koh Rong' },
      { src: '/assets/images/misc/sillyselfie.jpg', alt: 'Silly selfie on the boat' },
      { src: '/assets/images/misc/kampot.jpg', alt: 'Beautiful Kampot riverside' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Living the dream routine on Koh Rong - barefoot workouts, motorbike rides to pristine beaches, and the simple pleasures of island life.',
  ...
  },
  {
    ...
    year: '2025',
    excerpt: 'One of the best days of my life - profound introspection and connection with infinite love on the pristine beaches of Long Beach, Koh Rong.',
    ...
    images: [
      { src: '/assets/images/misc/longbeachwalk.jpg', alt: 'Long Beach walk at sunset' },
      { src: '/assets/images/misc/lbsunset.jpg', alt: 'Long Beach sunset view 1' },
      { src: '/assets/images/misc/lbsunset2.jpg', alt: 'Long Beach sunset view 2' }
    ]
  },
  {
    ...
    year: '2025',
    excerpt: 'Discovering my favorite place of the entire trip - swimming with bioluminescent plankton and sleeping on the beach at Lonely Beach.',
...
This reaction releases energy in the form of a blue-green glow, which is most visible in dark surroundings. Nature is so damn cool. I really enjoyed going straight to lonely beach away from all the main action. We drove a motorbike there and it was extremely hard to reach, making it even more special. The owner of the lonely beach bungalows was an old French guy born with extremely loose hips. He moved here 15 years ago, speaks fluent Cambodian, and wanted to do something he loves and caress about. The restaurant he has is really good too. I think this island is still in its infancy and would be a great place to invest.`,
    images: [
      ...
      { src: '/assets/images/misc/beachwalk.jpg', alt: 'Beach walk on Koh Rong' }
    ]
  }
];