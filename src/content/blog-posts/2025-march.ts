...
export const march2025Posts: BlogPost[] = [
  {
    ...
    year: '2025',
    excerpt:
      'Celebrating 6 months of world travel with awards for the best cities, experiences, and moments from across 12+ countries.',
...
• Life Spa, Chengdu, China 🇨🇳`,
  ...
  },
  {
    ...
    year: '2025',
    excerpt:
      'One of the coolest days of my life - buying a Honda Wave motorbike in Vietnam and riding 122km to Ninh Binh to start an epic adventure.',
...
It was a long day of driving, but I'm moving forward tomorrow. So stoked!`,
    images: [
      {
        src: '/assets/images/misc/meandbikey.jpg',
        alt: 'Me and my new Honda Wave motorbike',
      },
      {
        src: '/assets/images/misc/bikendrone.jpg',
        alt: 'Motorbike and drone setup',
      },
      {
        src: '/assets/images/misc/layingdragon.jpg',
        alt: 'Laying Dragon Viewpoint in Ninh Binh',
      },
    ],
  },
  {
    ...
    year: '2025',
    excerpt:
      "First day in Vietnam's capital - trying egg coffee, reuniting with travel friend Ben, and exploring the infamous Hoa Lo Prison.",
...
Tomorrow, I (hopefully) leave Hanoi and start a crazy adventure. Stay tuned for updates.`,
    images: [
      ...
      {
        src: '/assets/images/misc/prisoninfo.jpg',
        alt: 'Hoa Lo Prison information',
      },
      {
        src: '/assets/images/misc/trainstreeet.jpg',
        alt: 'Famous Train Street in Hanoi',
      },
    ],
  },
  {
    ...
    year: '2025',
    excerpt:
      'Relaxing in Chengdu with traditional Chinese massage, celebrating Shabbat with local expats, and sleeping overnight at a unique 24/7 life spa.',
...
Seeing China's unique landscapes and getting a glimpse of Tibetan culture outside of the big cities was an unforgettable experience.`,
    images: [
      {
        src: '/assets/images/misc/huanglong.jpg',
        alt: 'Huanglong National Park colored pools',
      },
      {
        src: '/assets/images/misc/juzzy1.jpg',
        alt: 'Jiuzhaigou National Park lake',
      },
      {
        src: '/assets/images/misc/juzzy2.jpg',
        alt: 'Jiuzhaigou National Park waterfall',
      },
    ],
  },
  {
    id: 'chengdu-people-park-apps',
    title: 'March 25th 2025, Chengdu, China',
    date: '2025-03-25',
    location: 'Chengdu, China',
    slug: 'chengdu-people-park-apps',
    year: '2025',
    excerpt:
      "Discovering China's unique life spa culture, learning about Chinese ethnic minorities, and navigating the essential apps needed for modern China.",
    content: `I went to the gym in the morning and had a nice, relatively normal day. Here in China, they have something called a "life spa." The one I went to was 11 stories tall. You can use the sauna and hot baths, but there's so much more. There's a full restaurant and over 20 different rooms to relax in—a salt room, a blue light room, a stone room, a volcano room, and more. They even have video games to play. You can even sleep there. I paid about $15 for the sauna and had some amazing Mapo Tofu there.
...
I found an awesome and cheap place on Trip.com. The owner, whose English name was Spencer, was a sweetheart. He spoke some English and told me he liked the USA. Even though I was exhausted, I gathered enough energy to walk to a famous bridge and riverside. I wanted to fly my drone for the first time, but I decided against it—it was dark, windy, and over water. Flying a drone is actually not that straightforward, and it would've sucked to lose it on my first try. Instead, I drank tea at the hotel and went to bed. A much-needed private room rest.`,
    images: [
      {
        src: '/assets/images/misc/qingshen.jpg',
      ...
      {
        src: '/assets/images/misc/dujiangynan.jpg',
        alt: 'Ancient Dujiangyan irrigation system',
      },
    ],
  },
  {
    id: 'chengdu-bathhouse-apps',
    title: 'March 22nd 2025, Chengdu, China',
    date: '2025-03-22',
    location: 'Chengdu, China',
    slug: 'chengdu-bathhouse-apps',
    year: '2025',
    excerpt:
      'Six months into my world tour - experiencing traditional Chinese bathhouse culture and navigating the essential apps for life in China.',
    content: `I slept terribly. An older Chinese gentleman in my room had a full-on conversation on speakerphone for much of the night. On top of that, my stomach was in shambles from the hotpot. I woke up late and feeling lethargic.
...
To end the day, I went back to People's Park at night for some tea.`,
    images: [
      {
        src: '/assets/images/misc/peopleparky.jpg',
        alt: "Evening at People's Park",
      },
      { src: '/assets/images/food/tofuwofu.jpg', alt: 'Traditional tofu dish' },
    ],
  },
  {
    id: 'cambodia-to-chengdu',
    title: 'March 21st 2025, Chengdu, China',
    date: '2025-03-21',
    location: 'Chengdu, China',
    slug: 'cambodia-to-chengdu',
    year: '2025',
    excerpt:
      'Epic 48-hour journey from Angkor Wat sunrise to arrival in China - experiencing the transit visa process and first impressions of Chengdu.',
    content: `I'm writing this from the airport in Chengdu on Saturday, March 29th. The past week in China has been incredibly busy, and due to internet restrictions and VPN issues, I haven't been able to post until now.
...
This reaction releases energy in the form of a blue-green glow, which is most visible in dark surroundings. Nature is so damn cool. I really enjoyed going straight to lonely beach away from all the main action. We drove a motorbike there and it was extremely hard to reach, making it even more special. The owner of the lonely beach bungalows was an old French guy born with extremely loose hips. He moved here 15 years ago, speaks fluent Cambodian, and wanted to do something he loves and caress about. The restaurant he has is really good too. I think this island is still in its infancy and would be a great place to invest.`,
    images: [
      { src: '/assets/images/misc/krmap.jpg', alt: 'Koh Rong island map' },
      { src: '/assets/images/misc/sunset.jpg', alt: 'Sunset at Lonely Beach' },
      {
        src: '/assets/images/misc/beachwalk.jpg',
        alt: 'Beach walk on Koh Rong',
      },
    ],
  },
]
