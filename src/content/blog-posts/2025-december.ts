...
So what do you do with this underlying principle? I think the only thing you can do is be adaptable, ride the wave, never be surprised, and seize the absurdity. If you learn to wield the improbable, instead of expecting simplicity, you can make some very life changing decisions, financially and socially.`,
  ...
  },
  {
    ...
    content: `Rachel and I arrived to Guatemala yesterday after celebrating Hanukkah with my family in Florida. Hanukkah dinner for the first night was memorable and one for the ages. It was really special. For the next three weeks Rachel and I will be backpacking around Guatemala.
...
I am feeling grateful, grounded, and focused. I am grateful for my strong body, intellectual mind, spiritual connection, friends, family, and life. Any of it can be taken at any second. Happy Hanukkah.`,
    images: [
      { src: '/assets/images/blog/2025/december/mevolcan.jpg', alt: 'Standing in front of a volcano in Antigua Guatemala' },
      { src: '/assets/images/blog/2025/december/bighguat.jpg', alt: 'Exploring the colonial streets of Antigua Guatemala' },
      { src: '/assets/images/blog/2025/december/rachelguat.jpg', alt: 'Rachel in Antigua Guatemala' }
    ]
  },
  {
    id: 'relentless-building',
    title: 'Relentless Building',
    date: 'December 9, 2025',
    location: 'Palm Harbor, FL',
    slug: 'relentless-building',
    year: '2025',
    excerpt: 'From sickness to rebirth, transitioning from data collection to the building phase of life.',
    content: `I have been sick the last two days. Being sick and weak really gives you perspective. I am grateful to say I rarely get sick so this really took me by surprise. It made me reflect how much I value my strong body and how I want to continue to improve it. Getting over a sickness also feels like a rebirth. I have been hyper aware of what I put in my body and how it will make me feel. I want to continue this. It is really difficult to do while at home and trying to line up meals with my parents but that is okay.
