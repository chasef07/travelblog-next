...
export const vlogsData: Vlog[] = [
  ...
  },
  {
    ...
    country: 'Guatemala',
    description:
      'A guide to El Paredon covering surf, backpacker scene, and what it is actually like on the ground.',
    youtubeId: 'NhrfjwvY9EQ',
  },
  {
    id: 'thailand-party',
    ...
    country: 'Thailand',
    description:
      'An over-the-top party experience in Thailand with full moon festivities',
  ...
  },
  {
    ...
    country: 'Nepal',
    description:
      'Exploring the beautiful culture and landscapes of the Himalayas',
  ...
  },
  {
    ...
    country: 'Tanzania',
    description:
      'A unique cultural experience hunting with the traditional Hadza tribe',
  ...
  },
  {
    ...
    country: 'Georgia',
    description:
      "Exploring Georgia's emerging ski destination and investment opportunities",
  ...
  },
  {
    ...
    country: 'Israel',
    description:
      'A firsthand account of surviving a historic missile attack in Israel',
