...
const tips: TipItem[] = [
  {
    title: '40L Maximum',
    description:
      'A 40L backpack is the maximum allowable carry-on size for most airlines.',
  },
  {
    title: 'Compression Cubes',
    description:
      'Use compression packing cubes. Organize pants in large, shirts in medium, shorts in small cubes.',
  },
  {
    title: 'Pack Light',
    description:
      'Pack light; you will definitely buy clothes along the way during your travels.',
  },
  {
    title: 'Organize Electronics',
    description:
      "Keep electronics separate and organized so cables don't get tangled and messy.",
  },
]
...
const packingItems: PackingItem[] = [
  ...
  {
    id: '1',
    name: 'Osprey 40L Farpoint backpack',
    category: 'backpacks',
    importance: 'essential',
    quantity: '1',
    link: 'https://www.osprey.com/farpoint-40-travel-pack-farpont40f22-296',
  },
  {
    id: '2',
    name: 'Osprey 15L daypack',
    category: 'backpacks',
    importance: 'essential',
    quantity: '1',
    link: 'https://www.osprey.com/farpoint-fairview-travel-daypack-farfairdayf22-235',
  },
  {
    id: '3',
    name: 'Eagle Creek compression packing cubes',
    category: 'backpacks',
    importance: 'recommended',
    quantity: '2',
    link: 'https://www.eaglecreek.com/products/pack-it-isolate-compression-cube-set-sm',
  },
  {
    id: '4',
    name: 'Large Thule double sided packing cube',
    category: 'backpacks',
    importance: 'recommended',
    quantity: '1',
    link: 'https://www.thule.com/en-us/organizers/packing-cubes-and-folders/thule-cleandirty-packing-cube-_-3204861',
  },
  {
    id: '5',
    name: 'Small Osprey packing cube for daypack',
    category: 'backpacks',
    importance: 'optional',
    quantity: '1',
    link: 'https://www.osprey.com/daylitetm-packing-cube-small',
  },
  ...
  },
  {
    ...
    importance: 'essential',
    quantity: '1',
    link: 'https://www.686.com/products/686-x-slowtide-performance-towel',
  },
  {
    id: '16',
    name: 'Source sandals',
    ...
    importance: 'essential',
    quantity: '1 pair',
    link: 'https://sourceoutdoor.com/product/men-classic-sandals/',
  },
  {
    id: '17',
    name: 'Hoka Clifton 9s',
    category: 'clothing',
    importance: 'essential',
    quantity: '1 pair',
    link: 'https://www.hoka.com/en/us/mens-everyday-running-shoes/clifton-9/197634066530.html',
  },
  {
    id: '18',
    name: 'OnClouds',
  ...
  {
    id: '26',
    name: 'International wall converters',
    category: 'electronics',
    importance: 'essential',
    quantity: '2',
  },
  {
    id: '27',
    name: 'Anker 24,000 mAh power bank',
    category: 'electronics',
    importance: 'essential',
    quantity: '1',
    link: 'https://www.anker.com/products/a1379',
  },
  {
    id: '28',
    name: 'AirTags',
  ...
  {
    id: '29',
    name: 'MacBook Air M2 and charger',
    category: 'electronics',
    importance: 'essential',
    quantity: '1',
  },
  {
    id: '30',
    name: 'iPhone 16 with magnetic phone wallet',
    category: 'electronics',
    importance: 'essential',
    quantity: '1',
  },
  ...
  {
    id: '40',
    name: 'Theragun mini percussion gun',
    category: 'health',
    importance: 'optional',
    quantity: '1',
    link: 'https://www.therabody.com/us/en-us/theragun-mini.html',
  },
...
export default function ModernPackingChecklist() {
  ...
  const overallProgress = Math.round(
    (checkedItems.size / packingItems.length) * 100,
  )
  ...
  const resetProgress = () => {
    const shouldReset = window.confirm(
      'Clear all checked items in your packing progress?',
    )
    ...
    <div className="space-y-16">
      <section className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-[var(--ui-border-subtle)] bg-[var(--ui-bg-strong)] p-5">
          <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[var(--ui-text-subtle)]">
            Packing Scope
          </p>
          <p className="mt-3 text-4xl font-extralight text-[var(--ui-text-primary)]">
            {packingItems.length}
          </p>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-[var(--ui-border-subtle)] border border-[var(--ui-border-subtle)]">
          {tips.map((tip, index) => (
            ...
            >
              <h3 className="text-[var(--ui-text-primary)] font-light mb-3">
                {tip.title}
              </h3>
                ...
                {items.map((item, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      {/* Importance Badge */}
                      <span
                        className={`rounded-full border px-2 py-1 font-mono text-[10px] uppercase tracking-[0.2em] ${getImportanceClasses(item.importance)}`}
                      >
                        {item.importance}
                      </span>
        ...
        <div className="grid md:grid-cols-2 gap-px bg-[var(--ui-border-subtle)] border border-[var(--ui-border-subtle)]">
          <div className="relative aspect-[4/3] overflow-hidden bg-[var(--ui-bg-strong)]">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              ...
              <p className="text-[var(--ui-text-primary)] text-sm">
                Everything organized and ready for adventure.
              </p>
            </div>
          </div>
          ...
          <div className="relative aspect-[4/3] overflow-hidden bg-[var(--ui-bg-strong)]">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              ...
              <p className="text-[var(--ui-text-primary)] text-sm">
                A perfectly organized backpack for year-long adventures.
              </p>
            </div>
          </div>
        </div>
